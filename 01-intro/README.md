<h1 align="center"> Introduction to FrontEnd Programming 📖 </h1>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>El administrador del sitio recibe la notificación de una nueva demanda y con los datos llenados del formulario se crea automáticamente el documento legal en formato word para empezar el proceso.</li>
          ...
          <li>La página debe de ser responsive para poder verla desde el celular.</li>
